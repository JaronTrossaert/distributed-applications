Thanks to the beautiful design of this work environment, the minimal work loss with accidents and the immediate replacement of employees, our boss has decided to expand his company.

Now he wants dynamically add workers to the company.
...
### id's
You no longer have to worry about id's. Just provide enough information so that the Dynamic Supervisor can start its child:
